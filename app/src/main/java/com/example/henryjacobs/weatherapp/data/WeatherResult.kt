...
data class WeatherResult(val coord: Coord?, val weather: List<Weather1806529473>?, val base: String?, val main: Main?, val visibility: Number?, val wind: Wind?, val clouds: Clouds?, val dt: Number?, val sys: Sys?, val id: Number?, val name: String?, val cod: Number?)
...
data class Weather1806529473(val id: Number?, val main: String?, val description: String?, val icon: String?)
